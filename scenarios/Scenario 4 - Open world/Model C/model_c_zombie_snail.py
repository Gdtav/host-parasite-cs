...
infectedPoopProb = 0.03  # Probability of a cell being occupied with a poop

infectionRate = 0.70  # Probability of getting infected with an parasite upon contact with it

regrowthRate = 0.15  # Probability of regrowing in cellular
deathProb = 0.80  # Probability of dying immediately (next iteration) after contracting the parasite
