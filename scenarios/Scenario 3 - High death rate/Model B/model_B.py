...
hostProb = 0.10  # Probability of the cell being occupied by a healthy host
infectedProb = 0.03  # Probability of cell being occupied by a host with parasite

infectionRate = 0.70  # Probability of getting infected with an parasite
regrowthRate = 0.15  # Probability of regrowing in cellular
deathProb = 0.80  # Probability of dying after contracting the parasite
                    ...
                    for neighbour in neigh_list:
                        if config[neighbour[0], neighbour[1]] == 1 and nextConfig[neighbour[0], neighbour[1]] == 1:
                            ...
                            if random() < infectionRate:
                                nextConfig[neighbour[0], neighbour[1]] = 5
